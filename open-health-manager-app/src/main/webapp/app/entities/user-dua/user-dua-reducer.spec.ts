...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './user-dua.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERDUA_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERDUA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERDUA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERDUA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERDUA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERDUA actions', async () => {
      const expectedActions = [
        {
