...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FHIRPATIENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_FHIRPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FHIRPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FHIRPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FHIRPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FHIRPATIENT actions', async () => {
      const expectedActions = [
        {
