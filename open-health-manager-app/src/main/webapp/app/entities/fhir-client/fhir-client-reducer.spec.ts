...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FHIRCLIENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_FHIRCLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FHIRCLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FHIRCLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FHIRCLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FHIRCLIENT actions', async () => {
      const expectedActions = [
        {
