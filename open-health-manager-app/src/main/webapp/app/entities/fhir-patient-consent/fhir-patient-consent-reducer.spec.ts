...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './fhir-patient-consent.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FHIRPATIENTCONSENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_FHIRPATIENTCONSENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FHIRPATIENTCONSENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FHIRPATIENTCONSENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FHIRPATIENTCONSENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FHIRPATIENTCONSENT actions', async () => {
      const expectedActions = [
        {
