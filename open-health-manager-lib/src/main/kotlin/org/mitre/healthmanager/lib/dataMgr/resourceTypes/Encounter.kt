...
fun Encounter.findUsernameViaLinkedPatient(patientDao : IFhirResourceDaoPatient<Patient>) : String? {
    return getPatientUsernameFromReference(this.subject, patientDao, "Encounter")
}