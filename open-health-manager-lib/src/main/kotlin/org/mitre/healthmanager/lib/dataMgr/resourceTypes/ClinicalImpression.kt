...
fun ClinicalImpression.findUsernameViaLinkedPatient(patientDao : IFhirResourceDaoPatient<Patient>) : String? {
    return getPatientUsernameFromReference(this.subject, patientDao, "ClinicalImpression")
}